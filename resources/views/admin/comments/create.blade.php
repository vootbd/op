...
<div class="inner-content">
    ...
    <section class="box-content">
        ...
        {!! Form::open(array('route' => ['comments.store', $sellerId], 'method'=> 'POST', 'class'=> 'form-block seller-profile-from-reset-'.$sellerId, 'enctype' => 'multipart/form-data','id' => 'comment-form-create','data-id' => (Auth::user()->hasRole('seller')) ? 'seller': 'operator','data-seller' => $sellerId)) !!}

        <span class="get-seller-id" data-id="{{ $sellerId }}"></span>

        {{-- {!! Form::open(array('route' => ['comments.store', $sellerId], 'method'=> 'POST', 'class'=> 'form-block', 'enctype' => 'multipart/form-data','id' => 'comment-form-create')) !!} --}}
            @csrf
             <div class="form-content">
                <div class="form-group d-flex">
                    ...
                    <div class="field-section">
                        {!! Form::textarea('comment', null, ['class' => 'comment','placeholder' => false]) !!}
