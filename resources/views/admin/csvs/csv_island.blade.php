...
<li class="breadcrumb-item active">離島 CSV 登録</li>
@endpush
...
<div class="inner-content">
    ...
    <section class="box-content">
        ...
        <div class="form-content">
            ...
            <div class="form-group d-flex">
                <div class="label-section label-section-error d-flex align-items-center"></div>
                <div class="field-section">
    ...
    <section class="box-content mt-20">
        ...
        <div class="csv-file-format-block">
            <div class="d-flex download-section">
                <a class="btn btn-download" href="{{ asset('csvformat/csv-island_template.csv') }}" download="{{ asset('csvformat/csv-island_template.csv') }}"><i class="rito rito-download"></i>雛形ファイルダウンロード</a>
            </div>
            ...
            @foreach ($islandFields as $key => $item)
            <div class="d-flex format-block-row">
