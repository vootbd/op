...
<li class="breadcrumb-item active">商品 CSV 登録</li>
@endpush
...
<div class="inner-content">
    ...
    <section class="box-content">
        ...
        {!! Form::open(array('route' => 'csv.product-create', 'method'=> 'POST', 'class'=> 'form-block', 'enctype' => 'multipart/form-data')) !!}
        @csrf
    ...
    <section class="box-content mt-20">
        ...
        <div class="csv-file-format-block">
            <div class="d-flex download-section">
                <a class="btn btn-download" href="{{ asset('csvformat/csv-product_template.csv') }}" download><i class="rito rito-download"></i>雛形ファイルダウンロード</a>
            </div>
            ...
            @foreach ($productFields as $key => $item)
            <div class="d-flex format-block-row">
