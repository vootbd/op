$(document).ready(function() {
  $("#company_name_id").keyup(function() {
    this.value = this.value.replace(/ /g, "_");
  });
  $("#company_name_id").bind("keyup blur", function(e) {
    $(this).val(
      $(this)
        .val()
  ...
  $("#company_name_id").on("paste", function(e) {
    e.preventDefault();
  });
      ...
      if(island_id){    
          ...
          if(prefecturex == -1){
              if (idx == -1) {                    
                  ...
                  $("#append-data").append('<input class="d-none" required type="hidden" name="island_ids[]" value="'+island_id+'" >');
